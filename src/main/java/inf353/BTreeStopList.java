...
public class BTreeStopList implements BTree<String>, Serializable {

    public Cell<String> root;
     ...
     * @author squadSkat
     */
    public BTreeStopList(Cell<String> root) {
     ...
     */
    @Override
    public void insert(Cell<String> newWord, Cell<String> parentWord) {
        ...
        // si le mot parent n'a pas de fils
            ...
            int compareResult = newWord.element.compareTo(parentWord.element);
     ...
     * @author squadSkat
     */
    private Pair<Boolean, Cell<String>> searchRec(String word, Cell<String> currentCell, Cell<String> parentCell) {

        // si le parent de la cellule courante n'a pas de fils
        if (currentCell == null) {

            // le cas où la cellule n'est pas trouvée
            return new Pair<Boolean, Cell<String>>(false, parentCell);
        }
        ...
        // si le parent de la cellule courante a des fils
            ...
            int compareResult = currentCell.element.compareTo(word);
            // si les mots sont égaux
            if (compareResult == 0) {

                return new Pair<Boolean, Cell<String>>(true, currentCell);
            }
     ...
     */
    @Override
    public Pair<Boolean, Cell<String>> search(String word) {

        // si l'arbre est vide
        if (this.root == null) {

            return new Pair<Boolean, Cell<String>>(false, null);
        }
     ...
     */
    @Override
    public void update(String newWord, Cell<String> previousWord) {
     ...
     * @author squadSkat
     */
    private Pair<Cell<String>, Cell<String>> biggestWord(Cell<String> elementRoot, Cell<String> parentRoot) {
        ...
        if (elementRoot.successorRight == null) {
            ...
            return new Pair<Cell<String>, Cell<String>>(elementRoot, parentRoot);
        }
     ...
     * @author squadSkat
     */
    private Pair<Cell<String>, Cell<String>> smallestWord(Cell<String> elementRoot, Cell<String> parentRoot) {
     ...
     * @author squadSkat
     */
    private Pair<Cell<String>, Cell<String>> biggestWordInSubTreeLeft(Cell<String> element) {
     ...
     * @author squadSkat
     */
    private Pair<Cell<String>, Cell<String>> smallestWordInSubTreeRight(Cell<String> element) {
     ...
     */
    @Override
    public void remove(Cell<String> word, Cell<String> parentWord) {
        ...
        // si le mot qu'on veux supprimer n'est pas une feuille
            ...
            if (word.successorLeft == null) {
                ...
                Pair<Cell<String>, Cell<String>> smallestRight = smallestWordInSubTreeRight(word);
            ...
            // si le mot n'a pas une sous arbre à droite
                ...
                Pair<Cell<String>, Cell<String>> biggestLeft = biggestWordInSubTreeLeft(word);
     ...
     * @author squadSkat
     */
    public void displayTree(Cell<String> rootTree) {
        ...
        afficheur.printWarningText(rootTree.element);
